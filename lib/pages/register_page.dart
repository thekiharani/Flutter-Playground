...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Widget build(BuildContext context) {
    _offsetHeight = _keyboardVisible ? 40 : 240;
    return Scaffold(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            SizedBox(height: 10),
                            InputWitIcon(Icons.phone_android, "Phone Number"),
                            SizedBox(height: 10),
                            InputWitIcon(Icons.person_add, "First Name"),
                            SizedBox(height: 10),
                            InputWitIcon(Icons.person_add, "Last Name"),
                            SizedBox(height: 10),
                        ...
                        child: Column(
                          children: [
                            GestureDetector(
                              ...
                              child: OutlinedBtn("Back to Home")
                            )
                          ],
                        ),
                      ),
